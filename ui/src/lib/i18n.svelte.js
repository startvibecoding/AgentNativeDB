...
const messages = {
  zh: {
    ...
    'nav.cluster': '集群',
    // 集群相关
    'cluster.clusterStatus': '集群状态',
    'cluster.leader': '主节点',
    'cluster.follower': '从节点',
    'cluster.candidate': '候选中',
    'cluster.nodes': '节点数',
    'cluster.currentTerm': '当前任期',
    'cluster.commitIndex': '提交索引',
    'cluster.nodeState': '节点状态',
    'cluster.nodeInfo': '节点信息',
    'cluster.nodeId': '节点 ID',
    'cluster.leaderId': '主节点 ID',
    'cluster.leaderAddr': '主节点地址',
    'cluster.lastApplied': '已应用索引',
    'cluster.state': '状态',
    'cluster.peers': '节点列表',
    'cluster.addPeer': '添加节点',
    'cluster.peerId': '节点 ID',
    'cluster.self': '本节点',
    'cluster.notEnabled': '集群模式未启用',
    'cluster.notEnabledDesc': '启动服务器时添加 -cluster 参数启用高可用集群模式',
    'cluster.fillAllFields': '请填写所有字段',
    'cluster.confirmRemove': '确定要移除节点 {id} 吗？',
    'cluster.stateLeader': '主节点',
    'cluster.stateFollower': '从节点',
    'cluster.stateCandidate': '候选中',
...
`,
  ...
  en: {
    ...
    'cluster.follower': 'Follower',
    'cluster.candidate': 'Candidate',
    'cluster.nodes': 'Nodes',
    'cluster.currentTerm': 'Current Term',
    'cluster.commitIndex': 'Commit Index',
    'cluster.nodeState': 'Node State',
    'cluster.nodeInfo': 'Node Info',
    'cluster.nodeId': 'Node ID',
    'cluster.leaderId': 'Leader ID',
    'cluster.leaderAddr': 'Leader Address',
    'cluster.lastApplied': 'Last Applied',
    'cluster.state': 'State',
    'cluster.peers': 'Peers',
    'cluster.addPeer': 'Add Peer',
    'cluster.peerId': 'Node ID',
    'cluster.self': 'Self',
    'cluster.notEnabled': 'Cluster mode not enabled',
    'cluster.notEnabledDesc': 'Start the server with -cluster flag to enable high availability clustering',
    'cluster.fillAllFields': 'Please fill in all fields',
    'cluster.confirmRemove': 'Are you sure you want to remove node {id}?',
    'cluster.stateLeader': 'Leader',
    'cluster.stateFollower': 'Follower',
    'cluster.stateCandidate': 'Candidate',
